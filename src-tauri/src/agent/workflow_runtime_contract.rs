...
use super::workflow_graph::{
    ...
    WORKFLOW_REASON_CLARIFY_REQUIRES_USER_INPUT, WORKFLOW_REASON_DELEGATE_TASK_COMPLETED,
    WORKFLOW_REASON_DELEGATE_TASK_FAILED, WORKFLOW_REASON_DELEGATE_TASK_STARTED,
    WORKFLOW_REASON_DIRECT_TURN, WORKFLOW_REASON_FINAL_ANSWER_CANDIDATE,
    WORKFLOW_REASON_FUTURE_CHECKPOINT_WAIT, WORKFLOW_REASON_GROUP_CONTEXT_READY,
    WORKFLOW_REASON_NO_GROUP_ROOM_CONTEXT, WORKFLOW_REASON_ORDER, WORKFLOW_REASON_QUEUED_TURN,
...
pub(super) const WORKFLOW_RUNTIME_EVENTS_SCHEMA: &str = "synthgraph_workflow_runtime_events_v1";
