...
This is ensemble round 2 of 2. Use prior reviews in this run directory as coordination messages.

Output contract for cc-team:
- You are producing the final artifact for codex-ensemble-implement-r2 (codex/implement).
